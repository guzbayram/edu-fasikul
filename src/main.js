// ═══════════════════════════════════════════════════════════
// EduFasikül — Faz 2: Core Modüller
// ═══════════════════════════════════════════════════════════
...
// ── Window globals — modüllerin main.js fonksiyonlarına erişimi ──
// Faz 3/4'te UI modülleri ayrılınca bu atamalar kalkacak.
function _registerWindowGlobals(){
  ...
  window.startOnboarding = typeof startOnboarding !== 'undefined' ? startOnboarding : ()=>{};
  ...
  // Auth fonksiyonları (HTML onclick handler'ları için)
...
// DOMContentLoaded'dan ÖNCE window globals'i kaydet
